sap.ui.define([
    ...
    return BaseController.extend("anubhav.app.zbipodata.controller.List", {
        ...
        onInit : function () {
            ...
            this._oGroupFunctions = {
                TotalAmount: function(oContext) {
                    var iNumber = oContext.getProperty('TotalAmount'),
                        key, text;
                    if (iNumber <= 20) {
                        key = "LE20";
        ...
        onOpenViewSettings: function (oEvent) {
            ...
            if (!this.byId("viewSettingsDialog")) {
                Fragment.load({
                    ...
                    name: "anubhav.app.zbipodata.view.ViewSettingsDialog",
                    controller: this
