		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "pizzaorders",
									"targetURL": "#anubhavappzbipodata-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"anubhavappzbipodata-display": {
								"semanticObject": "anubhavappzbipodata",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=anubhav.app.zbipodata",
									"url": sap.ui.require.toUrl("anubhav/app/zbipodata")
								}
							}
						}
					}
