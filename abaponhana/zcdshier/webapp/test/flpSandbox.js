		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "anubhav trainings hieeracycy",
									"targetURL": "#comanubhavtrainingszcdshier-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comanubhavtrainingszcdshier-display": {
								"semanticObject": "comanubhavtrainingszcdshier",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.anubhavtrainings.zcdshier",
									"url": sap.ui.require.toUrl("com/anubhavtrainings/zcdshier")
								}
							}
						}
					}
