		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "My ordersapp",
									"targetURL": "#myfioriapptan-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"myfioriapptan-display": {
								"semanticObject": "myfioriapptan",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=myfioriapptan",
									"url": sap.ui.require.toUrl("myfioriapptan")
								}
							}
						}
					}
