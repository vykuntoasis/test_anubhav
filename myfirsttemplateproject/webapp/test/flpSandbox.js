		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Anubhavtrainings.com",
									"targetURL": "#anubhavappmyfirsttemplateproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"anubhavappmyfirsttemplateproject-display": {
								"semanticObject": "anubhavappmyfirsttemplateproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=anubhav.app.myfirsttemplateproject",
									"url": sap.ui.require.toUrl("anubhav/app/myfirsttemplateproject")
								}
							}
						}
					}
