		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Basic OPA5",
									"targetURL": "#anubhavopa5opa5basicsopa5basics-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"anubhavopa5opa5basicsopa5basics-display": {
								"semanticObject": "anubhavopa5opa5basicsopa5basics",
								"action": "display",
								"description": "anubhavtrainings.com",
								"title": "Basic OPA5",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=anubhavopa5.opa5basics.opa5basics",
									"url": sap.ui.require.toUrl("anubhavopa5/opa5basics/opa5basics")
								}
							}
						}
					}
