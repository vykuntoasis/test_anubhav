		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "calcviewapp",
									"targetURL": "#comanubhavtrainingszanubhavcalc-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comanubhavtrainingszanubhavcalc-display": {
								"semanticObject": "comanubhavtrainingszanubhavcalc",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.anubhavtrainings.zanubhavcalc",
									"url": sap.ui.require.toUrl("com/anubhavtrainings/zanubhavcalc")
								}
							}
						}
					}
