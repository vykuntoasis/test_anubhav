		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Bestinpizzaapp",
									"targetURL": "#zbestinpizzaapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zbestinpizzaapp-display": {
								"semanticObject": "zbestinpizzaapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zbestinpizzaapp",
									"url": sap.ui.require.toUrl("zbestinpizzaapp")
								}
							}
						}
					}
